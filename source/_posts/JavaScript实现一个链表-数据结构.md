...
最近在找工作，然后看到boss直聘的论坛上，一个前端招聘者都在抱怨招不到合适的人，面了一大堆人，工作2-3年的，用JavaScript实现一个链表都寥寥无几，都没有聊下去的欲望....

所以在这了准备在写这篇博客，表明我实现过哈哈哈😂，抖个机灵，其实我看来面试官考察的你是否手写链表，而是你的**分析问题的能力，和抽象思维**
